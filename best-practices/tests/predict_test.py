...
def test_predict():
    ...
    student = {
        ...
        "Scholarship type": 4, "Additional work": 2,
        "Regular artistic or sports activity": 2,
        "Do you have a partner": 2, "Total salary if available": 3,
        "Transportation to the university": 1,
        "Accommodation type in Cyprus": 1,
        "Mother's education": 4, "Father's education": 3,
        "Number of sisters/brothers (if available)": 2,
        "Parental status": 1, "Mother's occupation": 3,
        "Father's occupation": 3, "Weekly study hours": 2,
